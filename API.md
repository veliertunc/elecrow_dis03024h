...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BOARD\_ELECROW_DIS03024H**](#define-bsp_board_elecrow_dis03024h)  <br> |
...
| define  | [**BSP\_I2C\_SCL**](#define-bsp_i2c_scl)  (GPIO\_NUM\_21)<br> |
| define  | [**BSP\_I2C\_SDA**](#define-bsp_i2c_sda)  (GPIO\_NUM\_22)<br> |
...
| define  | [**BSP\_SD\_SPI\_CS**](#define-bsp_sd_spi_cs)  (GPIO\_NUM\_5)<br> |
...
Check [example](https://github.com/espressif/esp-idf/blob/v5.5.2/examples/peripherals/dac/dac_continuous/dac_audio/main/dac_audio_example_main.c#L110) to write data to the speaker.
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_SPEAKER\_IO**](#define-bsp_speaker_io)  (GPIO\_NUM\_26)<br> |

## Functions Documentation

### function `bsp_speaker_new`

_Initialize speaker DAC._

```c
esp_err_t bsp_speaker_new (
    const bsp_speaker_config_t *,
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_LCD\_BACKLIGHT**](#define-bsp_lcd_backlight)  (GPIO\_NUM\_27)<br> |
...
| define  | [**BSP\_LCD\_DRAW\_BUFF\_SIZE**](#define-bsp_lcd_draw_buff_size)  (BSP\_LCD\_H\_RES \* 80)<br> |
| define  | [**BSP\_LCD\_H\_RES**](#define-bsp_lcd_h_res)  (240)<br> |
| define  | [**BSP\_LCD\_MISO**](#define-bsp_lcd_miso)  (GPIO\_NUM\_12)<br> |
| define  | [**BSP\_LCD\_MOSI**](#define-bsp_lcd_mosi)  (GPIO\_NUM\_13)<br> |
| define  | [**BSP\_LCD\_PCLK**](#define-bsp_lcd_pclk)  (GPIO\_NUM\_14)<br> |
...
| define  | [**ESP\_TOUCH\_CS**](#define-esp_touch_cs)    (GPIO\_NUM\_33)<br> |
| define  | [**ESP\_TOUCH\_INT**](#define-esp_touch_int)  (GPIO\_NUM\_39)<br> |
