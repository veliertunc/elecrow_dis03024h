...
/**
 * @file
 * @brief ESP BSP: Elecrow DIS03024H
 */
 ...
 *  @{
 */
#define BSP_BOARD_ELECROW_DIS03024H
/** @} */ // end of boardname
 ...
 *  @{
 */
#define BSP_I2C_SCL           (GPIO_NUM_21)
#define BSP_I2C_SDA           (GPIO_NUM_22)
/** @} */ // end of i2c
 ...
 *  @{
 */
#define BSP_SPEAKER_IO        (GPIO_NUM_26)
/** @} */ // end of audio
...
#define BSP_LCD_PCLK          (GPIO_NUM_14)
...
#define BSP_TOUCH_INT         (GPIO_NUM_39)
/** @} */ // end of display
 ...
 *  @{
 */
#define BSP_BUTTONS_NUM             CONFIG_BSP_BUTTONS_NUM

#define BSP_BUTTON_1_IO             (GPIO_NUM_25)
#define BSP_BUTTON_1_LEVEL          (1)
#define BSP_BUTTON_1_ADC_UNIT       (1)
#define BSP_BUTTON_1_ADC_CHANNEL    (8)
#define BSP_BUTTON_1_ADC_VALUE      (CONFIG_BSP_BUTTON_1_ADC_VALUE)

#define BSP_BUTTON_2_IO             (GPIO_NUM_32)
#define BSP_BUTTON_2_LEVEL          (1)
#define BSP_BUTTON_2_ADC_UNIT       (0)
#define BSP_BUTTON_2_ADC_CHANNEL    (4)
#define BSP_BUTTON_2_ADC_VALUE      (CONFIG_BSP_BUTTON_2_ADC_VALUE)
/** @} */ // end of buttons

/** @defgroup g06_uart UART
 *  @brief UART BSP API
 *
 *  @{
 */
#define BSP_UART_PORT               (UART_NUM_1)
#define BSP_UART_RX                 (GPIO_NUM_16)
#define BSP_UART_TX                 (GPIO_NUM_17)
/** @} */ // end of UART
 ...
 * Speaker interface
 *
 * Elecrow DIS03024H has a simple speaker that can be controlled via DAC.
 * The speaker must be initialized before use by calling bsp_speaker_init()
 **************************************************************************************************/
/**
 * @brief Initialize speaker DAC.
 *
 * @return
 *      - ESP_OK                On success
 ...
 *
 * @note The user has to manually add devices after the function call
 *
 * @return
 *      - ESP_OK                On success
 ...
 *
 * @note The user has to manually remove the slave devices before the function call
 *
 * @return
 *      - ESP_OK                On success
 *      - ESP_ERR_INVALID_ARG   I2C parameter error
...
#define BSP_SDSPI_HOST          (SPI3_HOST) // VSPI
 ...
 * LCD interface
 *
 * DIS03024H is shipped with 2.4-inch ILI9341V display controller.
 * It features 16-bit colors, 240x320 resolution.
 *
...
#define BSP_LCD_SPI_NUM            (SPI2_HOST) // HSPI

#if (BSP_CONFIG_NO_GRAPHIC_LIB == 0)
#define BSP_LCD_DRAW_BUFF_SIZE     (BSP_LCD_H_RES * 80)
 ...
 * BSP Features
 *
 * This module provides an interface to enable and disable various features on the DIS03024H board.
 ...
 * Button interface
 *
 * DIS03024H has two buttons accessed through GPIO_D connector:
 * - Button 1 (IO25)
 * - Button 2 (IO32)
 *
 **************************************************************************************************/
